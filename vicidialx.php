<?
# vicidial_redirect.php - forwards agents to another URL for login
# 
...
$URL = "http://192.168.1.241/agc/vicidial.php?phone_login=$phone_login&phone_pass=$phone_pass&DB=$DB&VD_login=$VD_login&VD_pass=$VD_pass&VD_campaign=$VD_campaign&relogin=$relogin";

echo"<TITLE>Employment</TITLE>\n";
