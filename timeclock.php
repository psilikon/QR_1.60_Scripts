<?php
// =->> Start QR Custom
// this replaces both 109 and .60 timeclock.php
// look for timeclock.bak for original file
// This is only 2 lines you need to remove to
// return to normal.
require_once("timeclock.inc.php");
// =->> End QR Custom
